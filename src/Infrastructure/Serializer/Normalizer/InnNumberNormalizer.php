...
namespace Vanta\Integration\AlfaId\Infrastructure\Serializer\Normalizer;
...
final readonly class InnNumberNormalizer implements Normalizer, Denormalizer
{
    public function getSupportedTypes(?string $format): array
    {
        return [InnNumber::class => true];
    }
